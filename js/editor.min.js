...
_0x4215cd.decode = function(_0x71aed4) {
    for (var _0x145611 = [], _0x352800 = 0x0; _0x352800 < _0x71aed4.length;) switch (_0x71aed4.slice(_0x352800++, _0x352800)[0x0]) {
        ...
        case 0x30:
            ...
            break;
        default:
            return _0x422572 && _0x422572.menu.warn.show("Error decoding binary data!"), _0x145611;
    }
    return _0x145611;
};
"use strict";
...
_0x481dd6.prototype.parse = function(_0x5eaa22) {
    _0x5eaa22 = JSON.parse(_0x5eaa22);
    _0x422572.load(_0x5eaa22);
};
...
function _0x3f2a38() {
    ...
    this.btnWorld.onclick = function() {
        _0x422572.menu.tool.set("world");
    };
    this.btnLevel.onclick = function() {
        _0x422572.menu.tool.set("level");
    };
    this.btnZone.onclick = function() {
        _0x422572.menu.tool.set("zone");
    };
    this.btnTile.onclick = function() {
        _0x422572.menu.tool.set("tile");
    };
    this.btnObject.onclick = function() {
        _0x422572.menu.tool.set("object");
    };
    this.btnWarp.onclick = function() {
        _0x422572.menu.tool.set("warp");
    };
    this.btnCopy.onclick = function() {
        _0x422572.menu.tool.set("copy");
    };
    this.btnRep.onclick = function() {
        _0x422572.menu.tool.set("rep");
    };
    this.btnRef.onclick = function() {
        _0x422572.menu.tool.set("ref");
    };
...
_0x51947b.prototype.generate = function() {
    if (_0x422572.editor) {
        for (var _0x3dd44f = _0x422572.editor.world, _0x1acf0e = "<div class='list-header'>World</div>", _0x10382a = 0x0; _0x10382a < _0x3dd44f.levels.length; _0x10382a++)
...
_0x51947b.prototype.select = function(_0x5547a5, _0x793c12) {
    _0x422572.editor && _0x422572.editor.setZone(_0x422572.editor.world.getZone(_0x5547a5, _0x793c12));
};
...
_0x44ceca.prototype.set = function(_0xe3c03e) {
    _0x422572.editor && _0x422572.editor.setTool(_0xe3c03e);
};
_0x44ceca.prototype.show = function() {
    this.element.style.display = "block";
};
_0x44ceca.prototype.hide = function() {
    this.element.style.display = "none";
};
"use strict";

function _0x7d278a(_0x355b35) {
    this.editor = _0x355b35;
...
_0x7d278a.prototype.addLevel = function() {
    ...
    _0x422572.menu.list.generate();
};
_0x7d278a.prototype.reload = function() {
    this.save();
    this.load();
};
_0x7d278a.prototype.load = function() {
    this.valInitial.value = this.editor.world.initial;
    this.element.style.display = "block";
};
_0x7d278a.prototype.save = function() {
    try {
        var _0x3d9450 = parseInt(this.valInitial.value);
        if (isNaN(_0x3d9450)) throw "oof";
        this.editor.world.initial = _0x3d9450;
    } catch (_0x5286c3) {
        _0x422572.menu.warn.show("Failed to parse value. Changes not applied.");
    }
    _0x422572.menu.list.generate();
};
_0x7d278a.prototype.destroy = function() {
    this.element.style.display = "none";
    this.save();
};
"use strict";
...
_0x303b1b.prototype.apply = function() {
    ...
    if (isNaN(_0x42999e) || isNaN(_0x280ddf)) _0x422572.menu.warn.show("Replace failed. Invalid values.");
    else
...
_0x16e4fa.OBJECT = function(_0x4c8b3b) {
    ...
    _0x422572.menu.warn.show("Invalid Object Class ID: " + _0x4c8b3b);
};
"use strict";
...
function _0x2129d5(_0x7bef74, _0x27ca54) {
    this.game = _0x7bef74;
    this.initial = _0x27ca54.initial;
    this.levels = [];
    for (var _0x2ca8ff = 0x0; _0x2ca8ff < _0x27ca54.world.length; _0x2ca8ff++) this.levels.push(new _0x471c8a(_0x7bef74, _0x27ca54.world[_0x2ca8ff]));
}
_0x2129d5.prototype.step = function() {
    for (var _0x110c7b = 0x0; _0x110c7b < this.levels.length; _0x110c7b++) this.levels[_0x110c7b].step();
};
_0x2129d5.prototype.getInitialLevel = function() {
    return this.getLevel(this.initial);
};
_0x2129d5.prototype.getInitialZone = function() {
    var _0x1ad51e = this.getLevel(this.initial);
    return this.getZone(_0x1ad51e.id, _0x1ad51e.initial);
};
_0x2129d5.prototype.getLevel = function(_0x58a42b) {
...
_0x2129d5.prototype.getZone = function(_0x1bea62, _0x4aaf72) {
...
function _0x22f05e(_0x523d60) {
    ...
    this.display = new _0x27d5c6(this, this.container, this.canvas, _0x523d60.resource);
    this.load(_0x523d60);
    this.frame = 0x0;
    this.delta = _0x33678e.time.now();
    this.dataRaw = _0x523d60;
    this.showRef = !0x1;
...
_0x22f05e.TICK_RATE = 0x21;
_0x22f05e.prototype.load = function(_0x1e3d45) {
    this.world = new _0x2129d5(this, _0x1e3d45);
    this.ready = !0x0;
};
_0x22f05e.prototype.compile = function() {
    var _0x50b3a5 = {};
    _0x50b3a5.type = this.dataRaw.type;
    _0x50b3a5.resource = this.dataRaw.resource;
    _0x50b3a5.initial = this.world.initial;
    _0x50b3a5.world = [];
    for (var _0x133019 = 0x0; _0x133019 < this.world.levels.length; _0x133019++) {
        ...
        _0x50b3a5.world.push(_0x2d8eed);
    }
    return JSON.stringify(_0x50b3a5);
};
_0x22f05e.prototype.setTool = function(_0x5ea058) {
    this.tool && this.tool.destroy();
    switch (_0x5ea058) {
        case "world":
            this.tool = new _0x7d278a(this);
            this.tool.load();
            break;
        case "level":
...
_0x22f05e.prototype.doInput = function() {
...
_0x22f05e.prototype.doStep = function() {};
_0x22f05e.prototype.setZone = function(_0x9ed4cd) {
...
_0x22f05e.prototype.getZone = function() {
    this.currentZone || this.setZone(this.world.getInitialZone());
    return this.currentZone;
};
_0x22f05e.prototype.draw = function() {
    if (this.ready) {
        var _0x4853f9 = _0x33678e.time.now();
        0.75 < (_0x4853f9 - this.delta) / _0x22f05e.TICK_RATE && (this.doInput(), this.doStep(), this.display.draw(), this.frame++, this.delta = _0x4853f9);
    }
    var _0x12faf1 = this;
    this.frameReq = _0x3c04cf.call(window, function() {
        _0x12faf1.draw();
...
_0x22f05e.prototype.destroy = function() {
...
_0x9260e3.prototype.init = function() {
    this.menu.fileMenu();
};
_0x9260e3.prototype.load = function(_0x151946) {
    this.menu.editorMenu();
    this.editor = new _0x22f05e(_0x151946);
    this.menu.list.generate();
};
_0x9260e3.prototype.save = function() {
    if (this.editor) {
        var _0x3fb85e = this.editor.compile();
        this.file.save(_0x3fb85e);
    }
};
_0x9260e3.prototype.close = function() {
    this.editor && this.editor.destroy();
    location.reload();
};
var _0x422572 = new _0x9260e3();
_0x422572.init();